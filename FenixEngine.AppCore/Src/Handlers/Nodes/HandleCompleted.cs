...
/// 
/// </summary>
public static class HandleCompletedExecution
{
    private static IMessageService messageService = new MessagesService(); 
    // 🎉 Completado
    public static async Task<StatesGenerator> HandleCompleted()
    {
        return HandleExtension.HandleFinish(messageService.GetMessage("Completed"));
    }
}