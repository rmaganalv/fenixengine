...
namespace FenixEngine.AppCore.src.Utils.Messages;
...
public class MessagesService : IMessageService
{
    ...
    new ResourceManager("AppCore.Generator.Src.Utils.Messages.MessagesService", typeof(MessagesService).Assembly);
    ...
    /// <param name="key"></param>
    /// <returns></returns>
    public string GetValidateMessage(string key)
    {
